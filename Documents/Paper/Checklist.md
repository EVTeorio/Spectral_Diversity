...
- [X] Decide whether all alpha hull including 3d metrics should be included
  - Updated decision, 2026-08-20: do not move forward with convex hull or 3D hull volume/area metrics in future analysis. Keep prior outputs as diagnostic/archive material only. Continue with alpha hull, mean distance, and Rao-style PCA metrics as the interpretable PCA metric set.
...
- [ ] Add a Results section on spectral metric relationships.
  ...
  - Treat convex hull and 3D hull volume/area results as excluded diagnostic checks, not as forward manuscript metrics.
...
- [X] Correlations with the other alpha/convex/3D hull metrics have been regenerated in `reports/tables/spectral_biodiversity_all_metrics/`, `reports/figures/spectral_biodiversity_all_metrics/`, and `reports/tables/spectral_heterogeneity_relationships/`. Updated decision, 2026-08-20: convex hull and 3D hull volume/area metrics will not be carried forward except as diagnostic/archive context.
