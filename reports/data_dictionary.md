...
- Row Count: 2,580 rows in `spectral_biodiversity_all_metric_dataset.csv`; 273 rows in `spectral_biodiversity_all_metric_relationships.csv`
- Column Count: 22 columns in the dataset; 12 columns in the relationship summary
